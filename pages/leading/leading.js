...
export default function Leading (){
    return(
        <>
            {/* Partners */}
            <div className='bg-slate-100 w-full h-48'>

            </div>
            <div className="flex flex-col items-center justify-center p-4 mt-6">
                <h2 className="w-[440px] text-center text-slate-900 text-3xl mb-4 mt-4">Aprender Linguas nacionais nunca foi tão fácil!</h2>
            ...
            <div className="flex flex-col justify-center items-center p-4 mt-24 bg-slate-900">
                <h2 className="w-[440px] text-center text-white text-3xl mb-4 mt-4">Criado com foco no seu nível de entendimento</h2>
                <div className="flex flex-row gap-10 mb-8 ">
                    <div className="flex flex-col items-center gap-4 border border-[#232e36] w-96 h-64 mt-12 p-4">
                        <FontAwesomeIcon icon={faEye} className="text-green-300 mr-2" size='3x'/>
                    ...
                    <div className=" flex flex-col items-center gap-4 border border-[#232e36] w-96 h-64 mt-12 p-4">
                        <FontAwesomeIcon icon={faHeadphones} className="text-green-300 mr-2" size='3x'/>
                    ...
                    <div className="flex flex-col items-center gap-4 border border-[#232e36] w-96 h-64 mt-12 p-4">
                        <FontAwesomeIcon icon={faVolumeUp} className="text-green-300  mr-2" size='3x'/>
                        <p className="text-white font-semibold text-2xl">Fale</p>
                        <p className='text-white text-center text-lg'>Por ser uma língua bantu interpretada, têm palavras com acentuações tónicas que se mal ditas/acentuadas podem ter outro significado e sentido.</p>
                    </div>
                </div>
            </div>
            {/* Family */}
            <div className="flex justify-start bg-slate-100 ">
                ...
                <div className='w-[700px] flex flex-col items-center justify-center'>
                    <FontAwesomeIcon icon={faLocationArrow} className="text-slate-800 mr-2"  size='4x'/>
                    <h2 className="w-[440px] text-center text-slate-900 text-3xl mb-4 mt-4">Aprenda na diáspora</h2>
            ...
            <div className='flex flex-col items-center justify-center mt-12 gap-2 p-4 rounded-sm drop-shadow-2xl'>
                <h2 className='w-[440px] text-center text-slate-900 text-3xl mb-4 mt-4'>Oiça músicas na língua nacional kimbundu <strong>e veja suas traduções</strong></h2>
                <div className='gap-4 flex flex-row items-center mt-4'>
                <div className="w-[500px] h-[400px]">
                        <Image width={500} height={400} objectFit='cover' quality={65} alt='Ouvir música' src='/sing.png'/>
                    </div>
                    <p className="w-96 text-center text-xl text-slate-900 font-normal mb-4 ml-30">Todo usuário que entende pode adicionar letras de músicas</p>
